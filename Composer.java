...
public class Composer extends Thread {
	...
	// jc: Replace Vector declaration with List<Grid>
	//Vector puzzles;
	List<Grid> puzzles ;
    ...
    public Composer( GridContainer gridContainer ,
        ...
        // jc: Replace new Vector declaration with new ArrayList<>
        //puzzles = new Vector();
    ...
    public synchronized void addSolution( int solverIndex ){
        ...
        if( ! puzzles.contains( puzzle ) ){
            ...
            lch.reset();
            // jc: Replace puzzles.addElement with puzzles.add
    ...
    @Override public void run(){
        ...
        synchronized( this ){
            ...
            if( gridContainer != null ){
                if( puzzles.size() > 0 ){
                	// jc: Replace puzzles.elementAt with puzzles.get
